...
class GeneralizedRCNN_distill(GeneralizedRCNN):
    ...
    def forward(self, batched_inputs, roi_s=None, gt_objectness_logits_s=None):
        ...
        return losses, logits_s, roi_s, gt_objectness_logits_s, normalizer
...
class Trainer(DefaultTrainer):
    ...
    def distill(self, data):
        # normalizer = 1.0 / (self.batch_size_per_image * self.num_images)
        loss_origin, logits_s, roi_s, gt_objectness_logits_s, normalizer = self.model(data)
        ...
        criterion_kd_roi_heads = self.criterion_kd_roi_heads(logits_s[1], logits_t[1])
        loss_distill = {
